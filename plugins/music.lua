do
  ...
  local function getLyrics(q)
    ...
    local output = 'برای دانلود موزیک لینک آن را به ربات \n@simple_downloader_bot\nبفرستید و موزیک خود را دریافت کنید \n\n'
	...
	-- Generate an awesome, well formated output
        ...
        .. '🕚مدت زمان موزیک ' .. time .. ' | ' .. ' 🎧کیفیت صدا ' .. bitrate .. ' | ' .. ' 📎حجم فایل  ' .. size .. '\n'
        .. '💾لینک دانلود موزیک : ' .. getDownloadLink(trackId) .. '\n\n '
